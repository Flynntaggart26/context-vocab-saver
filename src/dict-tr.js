...
const TR_DICT = {
  ...
  // ---- expanded core (v0.3.0) ----
  accept: 'kabul etmek', access: 'erişim', accident: 'kaza', across: 'karşısında', act: 'davranmak',
  action: 'eylem', activity: 'etkinlik', add: 'eklemek', admit: 'itiraf etmek', advice: 'tavsiye',
  affect: 'etkilemek', afford: 'gücü yetmek', afraid: 'korkmuş', after: 'sonra', afternoon: 'öğleden sonra',
  against: 'karşı', age: 'yaş', agree: 'katılmak, aynı fikirde olmak', agreement: 'anlaşma', air: 'hava',
  allow: 'izin vermek', amount: 'miktar', anger: 'öfke', animal: 'hayvan', announce: 'duyurmak',
  another: 'başka, bir diğeri', anybody: 'biri', anymore: 'artık', anyone: 'herhangi biri', anything: 'bir şey',
  anywhere: 'herhangi bir yer', apart: 'ayrı', apartment: 'daire', apologize: 'özür dilemek', appear: 'görünmek',
  apply: 'başvurmak', appointment: 'randevu', argue: 'tartışmak', arm: 'kol', army: 'ordu',
  around: 'etrafında', arrange: 'düzenlemek', arrive: 'varmak', art: 'sanat', article: 'makale',
  ashamed: 'utanmış', asleep: 'uykuda', assist: 'yardım etmek', assume: 'varsaymak', attach: 'iliştirmek',
  attack: 'saldırmak', attempt: 'denemek, girişim', attend: 'katılmak', attract: 'cezbetmek', audience: 'seyirci',
  author: 'yazar', available: 'mevcut', avoid: 'kaçınmak', awake: 'uyanık', award: 'ödül',
  aware: 'farkında', away: 'uzakta', awesome: 'harika', awful: 'berbat', basically: 'temelde',
  battle: 'savaş', behave: 'davranmak', belong: 'ait olmak', below: 'aşağıda', beside: 'yanında',
  besides: 'ayrıca', beyond: 'ötesinde', blame: 'suçlamak', blind: 'kör', blood: 'kan',
  board: 'tahta, pano', body: 'vücut', boil: 'kaynatmak', bold: 'cesur', border: 'sınır',
  borrow: 'ödünç almak', bottle: 'şişe', bottom: 'alt, dip', brain: 'beyin', brave: 'cesur',
  bread: 'ekmek', breath: 'nefes', breathe: 'nefes almak', bridge: 'köprü', brief: 'kısa, özet',
  bright: 'parlak', broad: 'geniş', broadcast: 'yayınlamak', broken: 'kırık, bozuk', budget: 'bütçe',
  burden: 'yük', burn: 'yanmak, yakmak', bury: 'gömmek', butter: 'tereyağı', button: 'düğme',
  calm: 'sakin', camera: 'kamera, fotoğraf makinesi', camp: 'kamp', cancel: 'iptal etmek', candle: 'mum',
  capable: 'yetenekli', care: 'önemsemek, bakım', career: 'kariyer', carpet: 'halı', carry: 'taşımak',
  cartoon: 'çizgi film', cash: 'nakit', cause: 'neden olmak, sebep', caution: 'dikkat, tedbir', ceiling: 'tavan',
  celebrate: 'kutlamak', century: 'yüzyıl', certain: 'emin, belli', chain: 'zincir', chair: 'sandalye',
};
