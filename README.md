...
[![Version](https://img.shields.io/badge/version-0.1.0-8b5cf6?style=flat-square)](https://github.com/Flynntaggart26/context-vocab-saver/releases)
[![Manifest](https://img.shields.io/badge/manifest-V3-2563eb?style=flat-square)](#)
[![Privacy](https://img.shields.io/badge/data-100%25%20local-059669?style=flat-square)](PRIVACY.md)
...
no server, no analytics, no tracking. See [PRIVACY.md](PRIVACY.md) (also usable
as the hosted policy URL for the Chrome Web Store listing).

## 🗺️ Roadmap to 1.0

- [ ] Text-to-speech pronunciation on cards (`chrome.tts`)
- [ ] Per-word notes / Turkish translation field
